...
public final class CaptureActivity extends AppCompatActivity implements SurfaceHolder.Callback {
    ...
    private ImageButton cameraFlashControl;
    ...
    public void onCreate(Bundle icicle) {
        ...
        cameraFlashControl = (ImageButton) findViewById(R.id.flash_control);
    ...
    private void cameraFlashControl() {
        ...
        if (cameraManager.flashControlHandler()) {
           // cameraFlashControl.setImageResource(R.drawable.close_flash);
            cameraFlashControl.setBackgroundResource(R.drawable.close_flash);

        } else {
         //   cameraFlashControl.setImageResource(R.drawable.open_flash);
            cameraFlashControl.setBackgroundResource(R.drawable.open_flash);
        }
